...
import {InitializeMonsterHP , fetchMonster } from "../redux/actions/monster.action";
...
const Monster = ({ monster, dispatch }) => {
  ...
  }, [monster.monsterInfo,monster.currentHealth, dispatch, navigate, mapLevel, user.email]);
      ...
      {monster.monsterInfo ? (
        <div>
          <div className="monster-hp">
            <StatsBar HPValue={monster.monsterInfo.health} currentHealth={monster.currentHealth} />
          </div>
          <img
